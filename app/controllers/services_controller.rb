...
class ServicesController < ApplicationController
  ...
  def create
    @services_param = params.require(:service).permit(:nombre, :descripcion, :cap_max, :precio, :user_id, :verified, :valoracion)
  ...
  def update
    @service = Service.find(params[:id])
    @services_param = params.require(:service).permit(:nombre, :descripcion, :cap_max, :precio, :verified, :valoracion)
