...
RSpec.describe User, type: :model do
    ...
    context 'when you try to create a user with out a last_name' do
    ...
    context 'when you try to create a user with out a email' do
    ...
    context 'when you try to create a user with out a password' do
    ...
    context 'when you try to create a user with out a password_confirmation' do
        it 'does not create because do not have a password_confirmation' do
            usuario = User.new(first_name: 'Tomás', last_name: 'Nora', email: 'tomas@tomas.com', password: 'dubost', admin: false, monedero: 0, image: nil)
            expect(usuario).not_to be_valid
        end
    end
    context 'when you try to create a user with out a admin' do
    ...
    context 'when you try to create a user with out a monedero' do
    ...
    context 'when you try to create a user with out a image' do
